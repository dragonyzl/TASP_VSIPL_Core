...
**********************************************************************/
/* $Id: ccfftip.t,v 1.1 2000/04/14 12:44:14 judd Exp judd $ */
...
{  
   printf("******\nTEST ccfftip forward\n");
   {
      ...
      for(i=0; i<4; i++){
        printf("vsip_fft_d *fft = vsip_ccfftip_create_d(np,1.0,VSIP_FFT_FWD,0,0)\n");
        printf("np = %4d\n",np[i]);
        ...
        { /* do fft */
          {
          vsip_fft_d *fft = vsip_ccfftip_create_d(np[i],1.0,VSIP_FFT_FWD,0,0);

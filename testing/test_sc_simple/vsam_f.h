...
/* $Id: vsam.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vsam_f(){
   printf("********\nTEST vsam_f\n");
   {
     vsip_scalar_f beta = 1.25;
     vsip_scalar_f data_a[] = { 1.1, 1.2, 2.1, 2.2, -3.1, -3.3};
     vsip_scalar_f data_b[] = {10.1, 11.2, 22.1, 12.2, -13.1, -0.3};
     vsip_scalar_f ans[] = { 23.735, 27.440, 74.035, 42.090, 24.235, 0.615 };
     ...
     printf("vsip_vsam_f(a,beta,c,d)\n");
     vsip_vsam_f(a,beta,b,c);
     printf("vector a\n");VU_vprintm_f("8.6",a);
     printf("beta = %f\n",beta);
     printf("vector c\n");VU_vprintm_f("8.6",b);
     printf("vector d\n");VU_vprintm_f("8.6",c);

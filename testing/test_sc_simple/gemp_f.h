...
static void gemp_f(){
   printf("********\nTEST gemp_f\n");
   {
     ...
     vsip_block_f *block_a = vsip_blockbind_f(data_a,15,0);
     vsip_block_f *block_b = vsip_blockbind_f(data_b,15,0);
     vsip_block_f *block_ans_nt = vsip_blockbind_f(ans_nt_data,9,0);
     vsip_block_f *block_ans_tn = vsip_blockbind_f(ans_tn_data,25,0);
     vsip_block_f *block  = vsip_blockcreate_f(400,0);
     ...
     vsip_mview_f *chk_nt = vsip_mcreate_f(3,3,VSIP_COL,0);
     vsip_mview_f *chk_tn = vsip_mcreate_f(5,5,VSIP_ROW,0);
     ...
     VU_msub_f(cnt,ans_nt,chk_nt); VU_mmag_f(chk_nt,chk_nt); VU_mclip_f(chk_nt,.0001,.0001,0,1,chk_nt);
     if(VU_msumval_f(chk_nt) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_msub_f(ctn,ans_tn,chk_tn); VU_mmag_f(chk_tn,chk_tn); VU_mclip_f(chk_tn,.0001,.0001,0,1,chk_tn);
     if(VU_msumval_f(chk_tn) > .5)
         printf("error\n");
     else
         printf("correct\n");

...
static void vsam_d(){
   printf("********\nTEST vsam_d\n");
   {
     ...
     vsip_scalar_d ans[] = { 23.735, 27.440, 74.035, 42.090, 24.235, 0.615 };
     ...
     printf("vsip_vsam_d(a,beta,c,d)\n");
     vsip_vsam_d(a,beta,b,c);
     printf("vector a\n");VU_vprintm_d("8.6",a);
     printf("beta = %f\n",beta);
     printf("vector c\n");VU_vprintm_d("8.6",b);
     printf("vector d\n");VU_vprintm_d("8.6",c);

...
static void mtrans_d(){
   printf("********\nTEST mtrans_d\n");
   {
     ...
     vsip_scalar_d data_2[] = {  .1,  .2,  .3,  .4,    
                                  1.0, 1.1, 1.2, 1.3,
                                  2.1, 2.2, 2.3, 2.4};
     vsip_block_d *block_1 = vsip_blockbind_d(data_1,16,0);
     vsip_block_d *block_2 = vsip_blockbind_d(data_2,12,0);
     vsip_block_d *block = vsip_blockcreate_d(200,0);
     ...
     vsip_mview_d *chk_1 = vsip_mcreate_d(4,4,VSIP_COL,0);
     vsip_mview_d *chk_2 = vsip_mcreate_d(4,3,VSIP_COL,0);
     vsip_mview_d *ans_1 = vsip_mcreate_d(4,4,VSIP_COL,0);
     vsip_mview_d *ans_2 = vsip_mcreate_d(4,3,VSIP_COL,0);
     ...
     VU_msub_d(a_1,ans_1,chk_1); VU_mmag_d(chk_1,chk_1); VU_mclip_d(chk_1,.0001,.0001,0,1,chk_1);
     if(VU_msumval_d(chk_1) > .5)
         printf("error\n\n");
     else
         printf("correct\n\n");
     ...
     VU_msub_d(c_2,ans_2,chk_2); VU_mmag_d(chk_2,chk_2); VU_mclip_d(chk_2,.0001,.0001,0,1,chk_2);
     if(VU_msumval_d(chk_2) > .5)
         printf("error\n");
     else
         printf("correct\n");

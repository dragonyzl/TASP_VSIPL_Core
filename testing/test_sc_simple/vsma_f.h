...
static void vsma_f(){
   printf("********\nTEST vsma_f\n");
   {
     ...
     vsip_scalar_f ans[] = { 11.475, 12.7, 24.725, 14.950, -16.975, -4.425};
     ...
     printf("vsip_vsma_f(a,beta,c,d)\n");
     vsip_vsma_f(a,beta,b,c);
     printf("vector a\n");VU_vprintm_f("8.6",a);
     printf("beta = %f\n",beta);
     printf("vector c\n");VU_vprintm_f("8.6",b);
     printf("vector d\n");VU_vprintm_f("8.6",c);

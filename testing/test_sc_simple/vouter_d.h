...
static void vouter_d(){
   printf("********\nTEST vouter_d\n");
   {
     ...
     vsip_block_d  *block_b = vsip_blockbind_d(data_b,4,0);
     vsip_block_d  *block_c = vsip_blockcreate_d(100,VSIP_MEM_NONE);
     vsip_block_d  *ans_block = vsip_blockbind_d(ans,24,0);
     ...
     vsip_mview_d  *chk = vsip_mcreate_d(6,4,VSIP_ROW,0);
     ...
     VU_msub_d(c,ansm,chk); VU_mmag_d(chk,chk); VU_mclip_d(chk,.0001,.0001,0,1,chk);

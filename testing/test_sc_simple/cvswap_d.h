...
/* $Id: cvswap.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void cvswap_d(){
   printf("********\nTEST cvswap_d\n");
   {
     ...
     vsip_cblock_d  *block1 = vsip_cblockbind_d(data1_r,data1_i,5,0);
     vsip_cblock_d  *block2 = vsip_cblockbind_d(data2_r,data2_i,5,0);
     vsip_cvview_d  *a = vsip_cvbind_d(block1,0,1,5);
     vsip_cvview_d  *b = vsip_cvbind_d(block2,0,1,5);
     vsip_cvview_d  *a1 = vsip_cvcreate_d(15,0);
     vsip_cvview_d  *b1 = vsip_cvcreate_d(45,0);

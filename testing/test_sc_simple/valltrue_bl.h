...
/* $Id: valltrue_bl.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void valltrue_bl(){
   printf("********\nTEST valltrue_bl\n");
   {
     vsip_scalar_bl  data1[] = { 1,  1, 1, 1, 1 };
     vsip_scalar_bl  data2[] = { 1,  0, 0, 0, 0 };
     vsip_scalar_bl  data3[] = { 0,  0, 0, 0, 0 };
     vsip_block_bl  *block1 = vsip_blockbind_bl(data1,5,0);
     vsip_block_bl  *block2 = vsip_blockbind_bl(data2,5,0);
     vsip_block_bl  *block3 = vsip_blockbind_bl(data3,5,0);
     ...
     vsip_vview_bl  *b = vsip_vcreate_bl(20,0);
     vsip_vview_f *fv = vsip_vcreate_f(5,0);
     ...
     vsip_vputoffset_bl(b,18); vsip_vputstride_bl(b,-2);

     vsip_vcopy_bl_f(a1,fv);vsip_vcopy_bl_bl(a1,b);
     printf("a1 = \n");VU_vprintm_f("1.0",fv);
     ...
     vsip_vcopy_bl_f(a2,fv);vsip_vcopy_bl_bl(a2,b);
     printf("a2 = \n");VU_vprintm_f("1.0",fv);
     ...
     vsip_vcopy_bl_bl(a3,b); vsip_vcopy_bl_f(b,fv);
     printf("a3 = \n");VU_vprintm_f("1.0",fv);

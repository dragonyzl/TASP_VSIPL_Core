...
/* $Id: vpolar.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vpolar_d(){
   printf("********\nTEST vpolar_d\n");
   {
     ...
     vsip_block_d  *block_arg = vsip_blockcreate_d(50,0);
     vsip_block_d  *block_mag = vsip_blockcreate_d(30,0);
     vsip_block_d  *ansa_block = vsip_blockbind_d(ans_a,6,0);
     vsip_block_d  *ansr_block = vsip_blockbind_d(ans_r,6,0);
     vsip_cvview_d  *a2 = vsip_cvcreate_d(6,0);

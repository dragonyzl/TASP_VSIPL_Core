...
static void vexpoavg_d(){
   printf("********\nTEST vexpoavg_d\n");
   {
        ...
        vsip_vview_d *ans = vsip_vcreate_d(10,0);
        vsip_vview_d *m1 = vsip_vbind_d(
                  vsip_blockbind_d(data1,10,0),0,1,10);
        vsip_vview_d *m2 = vsip_vbind_d(
                  vsip_blockbind_d(data2,10,0),0,1,10);
        vsip_vview_d *m3 = vsip_vbind_d(
                  vsip_blockbind_d(data3,10,0),0,1,10);
        vsip_vview_d *c = vsip_vcreate_d(10,0);

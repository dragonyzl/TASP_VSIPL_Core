...
/* $Id: vexpoavg.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vexpoavg_f(){
   printf("********\nTEST vexpoavg_f\n");
   {
        ...
        vsip_vview_f *ans = vsip_vcreate_f(10,0);
        vsip_vview_f *m1 = vsip_vbind_f(
                  vsip_blockbind_f(data1,10,0),0,1,10);
        vsip_vview_f *m2 = vsip_vbind_f(
                  vsip_blockbind_f(data2,10,0),0,1,10);
        vsip_vview_f *m3 = vsip_vbind_f(
                  vsip_blockbind_f(data3,10,0),0,1,10);
        vsip_vview_f *c = vsip_vcreate_f(10,0);
        vsip_vview_f *chk = vsip_vcreate_f(10,0);

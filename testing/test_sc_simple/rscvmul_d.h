...
static void rscvmul_d(){
   printf("********\nTEST rscvmul_d\n");
   {
     ...
     vsip_scalar_d ans_r[] = { 12.15, 15.30, -18.15, 15.30, -16.65, -3.45 };
     vsip_scalar_d ans_i[] = { 15.15, 16.80, 33.15, 18.30, -19.65, -0.45};
     ...
     printf("vsip_rscvmul_d(alpha,b,c)\n");
     vsip_rscvmul_d(alpha,b,c);
     printf(" alpha = %f) \n",alpha);
     printf("vector b\n");VU_cvprintm_d("8.6",b);
     printf("vector c\n");VU_cvprintm_d("8.6",c);

...
static void vscatter_d(){
   printf("********\nTEST vscatter_d\n");
   {
        ...
        vsip_vview_d *a = vsip_vbind_d(
                  vsip_blockbind_d(data1,6,0),0,1,6);
        ...
        vsip_vview_d *ans = vsip_vbind_d(
                  vsip_blockbind_d(data_ans,11,0),0,1,11);

        vsip_vview_d *b   = vsip_vcreate_d(11,0);
        vsip_vview_d *chk = vsip_vcreate_d(11,0);

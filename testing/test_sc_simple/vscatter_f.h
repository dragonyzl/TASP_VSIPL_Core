...
/* $Id: vscatter.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vscatter_f(){
   printf("********\nTEST vscatter_f\n");
   {
        ...
        vsip_vview_f *a = vsip_vbind_f(
                  vsip_blockbind_f(data1,6,0),0,1,6);
        ...
        vsip_vview_f *ans = vsip_vbind_f(
                  vsip_blockbind_f(data_ans,11,0),0,1,11);

        vsip_vview_f *b   = vsip_vcreate_f(11,0);
        vsip_vview_f *chk = vsip_vcreate_f(11,0);

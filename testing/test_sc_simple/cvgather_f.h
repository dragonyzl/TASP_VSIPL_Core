...
static void cvgather_f(){
   printf("********\nTEST cvgather_f\n");
   {
        ...
        vsip_cvview_f *a = vsip_cvbind_f(
                  vsip_cblockbind_f(data1_r,data1_i,14,0),0,1,14);
        ...
        vsip_cvview_f *ans = vsip_cvbind_f(
                  vsip_cblockbind_f(data_ans_r,data_ans_i,5,0),0,1,5);

        vsip_cvview_f *c = vsip_cvcreate_f(5,0);

...
/* $Id: cgemp.t,v 1.5 2000/04/14 12:27:55 judd Exp $ */
static void cgemp_f(){
   printf("********\nTEST cgemp_f\n");
   {
 ...
 -102.2225, -76.7225, -54.2013,-317.1125, 102.1125,
   ...
   27.3650,  53.6788,-107.6362, 234.3250, 402.5000
     ...
     vsip_cblock_f *block_a = vsip_cblockbind_f(data_ar,data_ai,15,0);
     vsip_cblock_f *block_b = vsip_cblockbind_f(data_br,data_bi,15,0);
     vsip_cblock_f *block_ans_nh = vsip_cblockbind_f(ans_nh_data_r,ans_nh_data_i,9,0);
     vsip_cblock_f *block_ans_hn = vsip_cblockbind_f(ans_hn_data_r,ans_hn_data_i,25,0);
     vsip_cblock_f *block_ans_tn = vsip_cblockbind_f(ans_tn_data_r,ans_tn_data_i,25,0);
     vsip_cblock_f *block  = vsip_cblockcreate_f(400,0);
     ...
     vsip_cmview_f *chk_nt = vsip_cmcreate_f(3,3,VSIP_COL,0);
     vsip_mview_f *chk_nt_r = vsip_mrealview_f(chk_nt);
     vsip_cmview_f *chk_tn = vsip_cmcreate_f(5,5,VSIP_ROW,0);
     ...
     VU_cmfill_f(vsip_cmplx_f(1.0,.5),cnt);
     VU_cmfill_f(vsip_cmplx_f(2.0,-1),ctn);
     ...
     VU_cmsub_f(cnt,ans_nh,chk_nt); VU_cmmag_f(chk_nt,chk_nt_r); VU_mclip_f(chk_nt_r,.0001,.0001,0,1,chk_nt_r);
     if(VU_msumval_f(chk_nt_r) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_cmsub_f(ctn,ans_hn,chk_tn); VU_cmmag_f(chk_tn,chk_tn_r); VU_mclip_f(chk_tn_r,.0001,.0001,0,1,chk_tn_r);
     if(VU_msumval_f(chk_tn_r) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_cmsub_f(ctn,ans_tn,chk_tn); VU_cmmag_f(chk_tn,chk_tn_r); VU_mclip_f(chk_tn_r,.0001,.0001,0,1,chk_tn_r);
     if(VU_msumval_f(chk_tn_r) > .5)
         printf("error\n");
     else
         printf("correct\n");

...
/* $Id: crvsub.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void crvsub_f(){
   printf("********\nTEST crvsub_f\n");
   {
     vsip_scalar_f data_b[]   = { 1.1,  1.2,    2.1,  2.2,  -3.1, -3.3};
     vsip_scalar_f data_a_r[] = { 8.1, 10.2,  -12.1, 10.2, -11.1, -2.3};
     vsip_scalar_f data_a_i[] = {10.1, 11.2,   22.1, 12.2, -13.1, -0.3};
     ...
     { vsip_vview_f *b_r = vsip_vrealview_f(d);
       vsip_vcopy_f_f(b,b_r);
       vsip_crvsub_f(a,b_r,d);
       vsip_vdestroy_f(b_r);
     }

...
static void cvexpoavg_d(){
    printf("\n******\nTEST cvexpoavg_d\n");
    {
        ...
        vsip_cvview_d *ans = vsip_cvcreate_d(9,0);
        vsip_cvview_d *m1 = vsip_cvbind_d(
                  vsip_cblockbind_d(data1,NDPTR_d,9,0),0,1,9);
        vsip_cvview_d *m2 = vsip_cvbind_d(
                  vsip_cblockbind_d(data2,NDPTR_d,9,0),0,1,9);
        vsip_cvview_d *m3 = vsip_cvbind_d(
                  vsip_cblockbind_d(data3,NDPTR_d,9,0),0,1,9);
        vsip_cvview_d *c = vsip_cvcreate_d(9,0);
        vsip_cvview_d *chk = vsip_cvcreate_d(9,0);

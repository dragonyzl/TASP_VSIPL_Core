...
/* $Id: vnot.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vnot_bl(){
   printf("********\nTEST vnot_bl\n");
   {
     vsip_scalar_bl  data[] = { 1,  1, 0, 0, 1 };
     vsip_scalar_bl  ans[]  = { 0,  0, 1, 1, 0};
     vsip_block_bl  *block = vsip_blockbind_bl(data,5,0);
     vsip_block_bl  *ans_block = vsip_blockbind_bl(ans,5,0);
     vsip_vview_bl  *a = vsip_vbind_bl(block,0,1,5);
     vsip_vview_bl  *ansv = vsip_vbind_bl(ans_block,0,1,5);
     vsip_vview_bl  *b = vsip_vcreate_bl(5,0);
     vsip_vview_f *fv = vsip_vcreate_f(5,0);
     vsip_vview_f *fv2 = vsip_vcreate_f(5,0);

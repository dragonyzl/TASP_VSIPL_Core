...
static void cvmmul_f(){
   printf("********\nTEST cvmmul_f\n");
   {
     ...
     vsip_cblock_f  *block_a1 = vsip_cblockbind_f(data_a1_r,data_a1_i,4,0);
     vsip_cblock_f  *block_a2 = vsip_cblockbind_f(data_a2_r,data_a2_i,6,0);
     vsip_cblock_f  *block_b = vsip_cblockbind_f(data_b,NDPTR_f,24,0);
     vsip_cblock_f  *block_c = vsip_cblockcreate_f(100,VSIP_MEM_NONE);
     vsip_cblock_f  *block_d = vsip_cblockcreate_f(100,VSIP_MEM_NONE);
     vsip_cblock_f  *ans1_block = vsip_cblockbind_f(ans1,NDPTR_f,24,0);
     vsip_cblock_f  *ans2_block = vsip_cblockbind_f(ans2,NDPTR_f,24,0);
     ...
     vsip_cmview_f  *chk = vsip_cmcreate_f(6,4,VSIP_COL,0);
     ...
     VU_cmsub_f(c,ansm1,chk); VU_cmmag_f(chk,chk_r); VU_mclip_f(chk_r,.0001,.0001,0,1,chk_r);
     if(VU_msumval_f(chk_r) > .5) 
         printf("error\n");
     else 
         printf("correct\n");
     ...
     VU_cmsub_f(d,ansm1,chk); VU_cmmag_f(chk,chk_r); VU_mclip_f(chk_r,.0001,.0001,0,1,chk_r);
     if(VU_msumval_f(chk_r) > .5) 
         printf("error\n");
     else 
         printf("correct\n");
     ...
     VU_cmsub_f(c,ansm2,chk); VU_cmmag_f(chk,chk_r); VU_mclip_f(chk_r,.0001,.0001,0,1,chk_r);
     if(VU_msumval_f(chk_r) > .5)
         printf("error\n");
     else 
         printf("correct\n");

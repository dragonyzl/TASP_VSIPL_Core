...
/* $Id: cvscatter.t,v 1.2 2000/04/14 12:27:55 judd Exp $ */
static void cvscatter_d(){
   printf("********\nTEST cvscatter_d\n");
   {
        ...
        vsip_cvview_d *a = vsip_cvbind_d(
                  vsip_cblockbind_d(data1_r,data1_i,6,0),0,1,6);

        vsip_vview_vi *index = vsip_vbind_vi(/* matrix index is always interleaved */
                  vsip_blockbind_vi(data_index,6,0),0,1,6);

        vsip_cvview_d *ans = vsip_cvbind_d(
                  vsip_cblockbind_d(data_ans_r,data_ans_i,11,0),0,1,11);

        vsip_cvview_d *b   = vsip_cvcreate_d(11,0);
        vsip_cvview_d *chk = vsip_cvcreate_d(11,0);
        ...
        vsip_cvfill_d(vsip_cmplx_d(0,0),b);

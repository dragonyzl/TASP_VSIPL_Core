...
static void vlle_f(){
   printf("********\nTEST vlle_f\n");
   {
      vsip_scalar_f data1[] = { 0.0, 1.2, 2.0, 4.2, 3.3, -2.2, 5.2};
      vsip_scalar_f data2[] = { 1.0, 1.2, 2.9, 4.2, 2.3, -2.2, 3.2};
      vsip_scalar_f ans_data[]   = { 1.0, 1.0, 1.0, 1.0, 0.0,  1.0, 0.0};

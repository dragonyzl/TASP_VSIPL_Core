...
static void cgemp_d(){
 ...
 -102.2225, -76.7225, -54.2013,-317.1125, 102.1125,
   ...
   27.3650,  53.6788,-107.6362, 234.3250, 402.5000
     ...
     vsip_cblock_d *block_b = vsip_cblockbind_d(data_br,data_bi,15,0);
     vsip_cblock_d *block_ans_nh = vsip_cblockbind_d(ans_nh_data_r,ans_nh_data_i,9,0);
     vsip_cblock_d *block_ans_hn = vsip_cblockbind_d(ans_hn_data_r,ans_hn_data_i,25,0);
     vsip_cblock_d *block_ans_tn = vsip_cblockbind_d(ans_tn_data_r,ans_tn_data_i,25,0);
     ...
     vsip_cmview_d *chk_nt = vsip_cmcreate_d(3,3,VSIP_COL,0);
     vsip_mview_d *chk_nt_r = vsip_mrealview_d(chk_nt);
     vsip_cmview_d *chk_tn = vsip_cmcreate_d(5,5,VSIP_ROW,0);
     ...
     VU_cmfill_d(vsip_cmplx_d(1.0,.5),cnt);
     VU_cmfill_d(vsip_cmplx_d(2.0,-1),ctn);
     ...
     VU_cmsub_d(cnt,ans_nh,chk_nt); VU_cmmag_d(chk_nt,chk_nt_r); VU_mclip_d(chk_nt_r,.0001,.0001,0,1,chk_nt_r);
     if(VU_msumval_d(chk_nt_r) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_cmsub_d(ctn,ans_hn,chk_tn); VU_cmmag_d(chk_tn,chk_tn_r); VU_mclip_d(chk_tn_r,.0001,.0001,0,1,chk_tn_r);
     if(VU_msumval_d(chk_tn_r) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_cmsub_d(ctn,ans_tn,chk_tn); VU_cmmag_d(chk_tn,chk_tn_r); VU_mclip_d(chk_tn_r,.0001,.0001,0,1,chk_tn_r);
     if(VU_msumval_d(chk_tn_r) > .5)
         printf("error\n");
     else
         printf("correct\n");

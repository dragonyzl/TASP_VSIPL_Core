...
static void cvdiv_f(){
   printf("********\nTEST cvdiv_f\n");
   {
     ...
     vsip_scalar_f ans_r[] = {  0.1678 ,0.2008 ,0.1131 ,0.0174 ,-0.0543 ,-2.0818 };
     vsip_scalar_f ans_i[] = {  -0.0734 ,-0.1028 ,0.0331 ,0.1949 ,0.3433 ,1.7063 };
     ...
     printf("vsip_cvdiv_f(a,b)\n");
     vsip_cvdiv_f(a,b,c);
     printf("cvdiv_f(a,b,c)\n vector a\n");VU_cvprintm_f("8.6",a);
     printf("vector b\n");VU_cvprintm_f("8.6",b);
     printf("vector c\n");VU_cvprintm_f("8.6",c);

...
static void cvswap_f(){
   printf("********\nTEST cvswap_f\n");
   {
     ...
     vsip_cblock_f  *block1 = vsip_cblockbind_f(data1_r,data1_i,5,0);
     vsip_cblock_f  *block2 = vsip_cblockbind_f(data2_r,data2_i,5,0);
     vsip_cvview_f  *a = vsip_cvbind_f(block1,0,1,5);
     vsip_cvview_f  *b = vsip_cvbind_f(block2,0,1,5);
     vsip_cvview_f  *a1 = vsip_cvcreate_f(15,0);
     vsip_cvview_f  *b1 = vsip_cvcreate_f(45,0);

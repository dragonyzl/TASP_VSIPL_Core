...
static void gems_d(){
   ...
   11.5,    4.6,    2.5 };                                     
     ...
     vsip_block_d *block_ans_n = vsip_blockbind_d(ans_n_data,15,0);
     vsip_block_d *block_ans_t = vsip_blockbind_d(ans_t_data,15,0);
     ...
     vsip_mview_d *chk_n = vsip_mcreate_d(3,5,VSIP_COL,0);
     vsip_mview_d *chk_t = vsip_mcreate_d(5,3,VSIP_ROW,0);
     ...
     VU_msub_d(cn,ans_n,chk_n); VU_mmag_d(chk_n,chk_n); VU_mclip_d(chk_n,.0001,.0001,0,1,chk_n);
     if(VU_msumval_d(chk_n) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_msub_d(ct,ans_t,chk_t); VU_mmag_d(chk_t,chk_t); VU_mclip_d(chk_t,.0001,.0001,0,1,chk_t);
     if(VU_msumval_d(chk_t) > .5)
         printf("error\n");
     else
         printf("correct\n");

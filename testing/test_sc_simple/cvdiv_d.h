...
/* $Id: cvdiv.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void cvdiv_d(){
   printf("********\nTEST cvdiv_d\n");
   {
     ...
     vsip_scalar_d ans_r[] = {  0.1678 ,0.2008 ,0.1131 ,0.0174 ,-0.0543 ,-2.0818 };
     vsip_scalar_d ans_i[] = {  -0.0734 ,-0.1028 ,0.0331 ,0.1949 ,0.3433 ,1.7063 };

     vsip_cblock_d  *block_a = vsip_cblockbind_d(data_a_r,data_a_i,6,0);
     vsip_cblock_d  *block_b = vsip_cblockbind_d(data_b_r,data_b_i,6,0);
     vsip_cblock_d  *block_c = vsip_cblockcreate_d(30,VSIP_MEM_NONE);
     vsip_cblock_d  *block_d = vsip_cblockcreate_d(30,VSIP_MEM_NONE);
     vsip_cblock_d  *ans_block = vsip_cblockbind_d(ans_r,ans_i,6,0);
     ...
     vsip_cvview_d  *chk = vsip_cvcreate_d(6,0);
     ...
     printf("vsip_cvdiv_d(a,b)\n");
     vsip_cvdiv_d(a,b,c);
     printf("cvdiv_d(a,b,c)\n vector a\n");VU_cvprintm_d("8.6",a);
     printf("vector b\n");VU_cvprintm_d("8.6",b);
     printf("vector c\n");VU_cvprintm_d("8.6",c);

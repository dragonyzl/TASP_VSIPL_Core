...
static void cvexpoavg_f(){
    printf("\n******\nTEST cvexpoavg_f\n");
    {
        ...
        vsip_cvview_f *ans = vsip_cvcreate_f(9,0);
        vsip_cvview_f *m1 = vsip_cvbind_f(
                  vsip_cblockbind_f(data1,NDPTR_f,9,0),0,1,9);
        vsip_cvview_f *m2 = vsip_cvbind_f(
                  vsip_cblockbind_f(data2,NDPTR_f,9,0),0,1,9);
        vsip_cvview_f *m3 = vsip_cvbind_f(
                  vsip_cblockbind_f(data3,NDPTR_f,9,0),0,1,9);
        vsip_cvview_f *c = vsip_cvcreate_f(9,0);
        vsip_cvview_f *chk = vsip_cvcreate_f(9,0);

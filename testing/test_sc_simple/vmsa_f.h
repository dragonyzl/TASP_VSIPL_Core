...
/* $Id: vmsa.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vmsa_f(){
   printf("********\nTEST vmsa_f\n");
   {
     vsip_scalar_f gamma = -0.25;
     vsip_scalar_f data_a[] = { 1.1, 1.2, 2.1, 2.2, -3.1, -3.3};
     vsip_scalar_f data_b[] = {10.1, 11.2, 22.1, 12.2, -13.1, -0.3};
     vsip_scalar_f ans[] = { 10.86, 13.19, 46.16, 26.59, 40.36, 0.74};
     ...
     printf("vsip_vmsa_f(a,b,gamma,d)\n");
     vsip_vmsa_f(a,b,gamma,c);
     printf("vector a\n");VU_vprintm_f("8.6",a);
     printf("vector b\n");VU_vprintm_f("8.6",b);
     printf("gamma = %f\n",gamma);
     printf("vector d\n");VU_vprintm_f("8.6",c);

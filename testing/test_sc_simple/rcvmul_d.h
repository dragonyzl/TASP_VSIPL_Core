...
/* $Id: rcvmul.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void rcvmul_d(){
   printf("********\nTEST rcvmul_d\n");
   {
     ...
     vsip_scalar_d ans_r[]    = {  8.91, 12.24,-25.41, 22.44, 34.41, 7.59 };
     vsip_scalar_d ans_i[]    = { 11.11, 13.44, 46.41, 26.84, 40.61, 0.99 };

...
/* $Id: cvmmul.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void cvmmul_d(){
   printf("********\nTEST cvmmul_d\n");
   {
     ...
     vsip_cblock_d  *block_a1 = vsip_cblockbind_d(data_a1_r,data_a1_i,4,0);
     vsip_cblock_d  *block_a2 = vsip_cblockbind_d(data_a2_r,data_a2_i,6,0);
     vsip_cblock_d  *block_b = vsip_cblockbind_d(data_b,NDPTR_d,24,0);
     vsip_cblock_d  *block_c = vsip_cblockcreate_d(100,VSIP_MEM_NONE);
     vsip_cblock_d  *block_d = vsip_cblockcreate_d(100,VSIP_MEM_NONE);
     vsip_cblock_d  *ans1_block = vsip_cblockbind_d(ans1,NDPTR_d,24,0);
     vsip_cblock_d  *ans2_block = vsip_cblockbind_d(ans2,NDPTR_d,24,0);
     ...
     vsip_cmview_d  *chk = vsip_cmcreate_d(6,4,VSIP_COL,0);
     ...
     VU_cmsub_d(c,ansm1,chk); VU_cmmag_d(chk,chk_r); VU_mclip_d(chk_r,.0001,.0001,0,1,chk_r);
     if(VU_msumval_d(chk_r) > .5) 
         printf("error\n");
     else 
         printf("correct\n");
     ...
     VU_cmsub_d(d,ansm1,chk); VU_cmmag_d(chk,chk_r); VU_mclip_d(chk_r,.0001,.0001,0,1,chk_r);
     if(VU_msumval_d(chk_r) > .5) 
         printf("error\n");
     else 
         printf("correct\n");
     ...
     VU_cmsub_d(c,ansm2,chk); VU_cmmag_d(chk,chk_r); VU_mclip_d(chk_r,.0001,.0001,0,1,chk_r);
     if(VU_msumval_d(chk_r) > .5)
         printf("error\n");
     else 
         printf("correct\n");

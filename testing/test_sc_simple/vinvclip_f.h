...
/* $Id: vinvclip.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vinvclip_f(){
   printf("********\nTEST vinvclip_f\n");
   {
        ...
        vsip_block_f *block = vsip_blockbind_f(data,10,0);
        vsip_block_f *block_ans = vsip_blockbind_f(data_ans,10,0);
        vsip_vview_f *a = vsip_vbind_f(block,0,1,10);
        vsip_vview_f *ans = vsip_vbind_f(block_ans,0,1,10);
        vsip_vview_f *b = vsip_vcreate_f(10,0);

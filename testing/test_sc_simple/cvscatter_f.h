...
static void cvscatter_f(){
   printf("********\nTEST cvscatter_f\n");
   {
        ...
        vsip_cvview_f *a = vsip_cvbind_f(
                  vsip_cblockbind_f(data1_r,data1_i,6,0),0,1,6);
        ...
        vsip_cvview_f *ans = vsip_cvbind_f(
                  vsip_cblockbind_f(data_ans_r,data_ans_i,11,0),0,1,11);

        vsip_cvview_f *b   = vsip_cvcreate_f(11,0);
        vsip_cvview_f *chk = vsip_cvcreate_f(11,0);
        ...
        vsip_cvfill_f(vsip_cmplx_f(0,0),b);

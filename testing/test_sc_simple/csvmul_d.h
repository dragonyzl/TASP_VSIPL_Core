...
/* $Id: csvmul.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void csvmul_d(){
   printf("********\nTEST csvmul_d\n");
   {
     ...
     vsip_scalar_d ans_r[] = { 34.3700, 39.9400, 30.4700, 42.1400, -45.4700, -4.1100 };
     vsip_scalar_d ans_i[] = { -2.6700, -5.6400, 59.7700, -4.1400, 4.7700, 4.6100 };
     ...
     printf("vsip_csvmul_d(alpha,b,c)\n");
     vsip_csvmul_d(alpha,b,c);

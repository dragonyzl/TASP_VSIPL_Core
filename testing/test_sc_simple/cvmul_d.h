...
/* $Id: cvmul.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void cvmul_d(){
   printf("********\nTEST cvmul_d\n");
   {
     ...
     vsip_scalar_d ans_r[] = { 5.9000,  19.2000, -21.0000, -49.2800, -97.2200, -13.1800 };
     vsip_scalar_d ans_i[] = { 30.1200, 48.0800, -71.8200, -4.4000, -32.4000, 6.0000 }; 

...
static void vpolar_f(){
   printf("********\nTEST vpolar_f\n");
   {
     ...
     vsip_block_f  *block_arg = vsip_blockcreate_f(50,0);
     vsip_block_f  *block_mag = vsip_blockcreate_f(30,0);
     vsip_block_f  *ansa_block = vsip_blockbind_f(ans_a,6,0);
     vsip_block_f  *ansr_block = vsip_blockbind_f(ans_r,6,0);
     vsip_cvview_f  *a2 = vsip_cvcreate_f(6,0);

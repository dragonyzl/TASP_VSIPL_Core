...
/* $Id: vgather.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vgather_d(){
   printf("********\nTEST vgather_d\n");
   {
        ...
        vsip_vview_d *a = vsip_vbind_d(
                  vsip_blockbind_d(data1,14,0),0,1,14);
        ...
        vsip_vview_d *ans = vsip_vbind_d(
                  vsip_blockbind_d(data_ans,5,0),0,1,5);

        vsip_vview_d *c = vsip_vcreate_d(5,0);

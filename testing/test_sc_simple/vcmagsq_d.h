...
/* $Id: vcmagsq.t,v 1.2 2000/04/14 12:27:55 judd Exp $ */
static void vcmagsq_d(){
   printf("********\nTEST vcmagsq_d\n");
   {
     vsip_scalar_d data_a_i[] = { 1.1, -1.2, 2.1, 2.2, -3.1, -3.3};
     vsip_scalar_d data_a_r[] = { 2.1, -3.2, -2.1, -2.2, +5.1, +5.3};
     vsip_scalar_d ans[] = {  5.62, 11.68, 8.82, 9.68, 35.62, 38.98};

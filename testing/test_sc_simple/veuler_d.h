...
/* $Id: veuler.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void veuler_d(){
   printf("********\nTEST veuler_d\n");
   {
      ...
      vsip_cblock_d *ans_block = vsip_cblockbind_d(ansdata,NDPTR_d,5,0);
      vsip_vview_d  *a = vsip_vbind_d(block,0,1,5);
      vsip_cvview_d *ans = vsip_cvbind_d(ans_block,0,1,5);
      vsip_cvview_d *b = vsip_cvcreate_d(5,0);

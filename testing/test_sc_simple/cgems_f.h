...
static void cgems_f(){
  ...
  -10.875, -0.55,   -3.675, -5.25,  -10.025};
   ...
   13.25,   6.700,  5.90};
     ...
     vsip_cblock_f *block_ans_n = vsip_cblockbind_f(ans_n_data_r,ans_n_data_i,15,0);
     vsip_cblock_f *block_ans_c = vsip_cblockbind_f(ans_c_data_r,ans_c_data_i,15,0);
     vsip_cblock_f *block_ans_t = vsip_cblockbind_f(ans_t_data_r,ans_t_data_i,15,0);
     ...
     vsip_cmview_f *chk_n = vsip_cmcreate_f(3,5,VSIP_COL,0);
     vsip_cmview_f *chk_t = vsip_cmcreate_f(5,3,VSIP_ROW,0);
     ...
     VU_cmfill_f(vsip_cmplx_f(1.0,.5),cn);
     VU_cmfill_f(vsip_cmplx_f(2.0,-1),ct);
     ...
     VU_cmsub_f(cn,ans_n,chk_n); VU_cmmag_f(chk_n,chk_n_r); VU_mclip_f(chk_n_r,.0001,.0001,0,1,chk_n_r);
     if(VU_msumval_f(chk_n_r) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_cmsub_f(cn,ans_c,chk_n); VU_cmmag_f(chk_n,chk_n_r); VU_mclip_f(chk_n_r,.0001,.0001,0,1,chk_n_r);
     if(VU_msumval_f(chk_n_r) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_cmsub_f(ct,ans_t,chk_t); VU_cmmag_f(chk_t,chk_t_r); VU_mclip_f(chk_t_r,.0001,.0001,0,1,chk_t_r);
     if(VU_msumval_f(chk_t_r) > .5)
         printf("error\n");
     else
         printf("correct\n");

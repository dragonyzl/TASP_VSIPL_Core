...
/* $Id: vacos.t,v 1.2 2000/04/14 12:27:55 judd Exp $ */
static void vacos_f(){
   printf("********\nTEST vacos_f\n");
   {
     vsip_scalar_f data[] = {.1, .2, .3, .4, .5, .6, .7, .8};
     vsip_scalar_f ans[] = {  1.4706, 1.3694, 1.2661, 1.1593, 1.0472, 0.9273, 0.7954, 0.6435 };
     ...
     vsip_vsub_f(a,ansv,chk); vsip_vmag_f(chk,chk); vsip_vclip_f(chk,.0001,.0001,0,1,chk);
     if(vsip_vsumval_f(chk) > .5) 
         printf(" vacos_f in error for in place\n");
     else {
         printf("correct\n");
     }

...
/* $Id: vhypot.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void vhypot_d(){
   printf("********\nTEST vhypot_d\n");
   {
     vsip_scalar_d data_a[] = {.1, .0, .3, 4, .5, 6, .7, 8};
     vsip_scalar_d data_b[] = {.0, .2, .3, .4, 5, .6, 7, .8};
     vsip_scalar_d ans[]    = {  0.1, 0.2, 0.4243, 4.02, 5.0249, 6.0299, 7.0349, 8.0399 };
     vsip_block_d  *block_a = vsip_blockbind_d(data_a,8,0);
     vsip_block_d  *block_b = vsip_blockbind_d(data_b,8,0);
     ...
     vsip_vview_d  *c = vsip_vcreate_d(30,0);

...
/* $Id: rvcmmul.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void rvcmmul_f(){
   printf("********\nTEST rvcmmul_f\n");
   {
     ...
     vsip_block_f   *block_a1 = vsip_blockbind_f(data_a1,4,0);
     vsip_block_f   *block_a2 = vsip_blockbind_f(data_a2,6,0);

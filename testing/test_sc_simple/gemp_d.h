...
/* $Id: gemp.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void gemp_d(){
   printf("********\nTEST gemp_d\n");
   {
     ...
     vsip_block_d *block_a = vsip_blockbind_d(data_a,15,0);
     vsip_block_d *block_b = vsip_blockbind_d(data_b,15,0);
     vsip_block_d *block_ans_nt = vsip_blockbind_d(ans_nt_data,9,0);
     vsip_block_d *block_ans_tn = vsip_blockbind_d(ans_tn_data,25,0);
     vsip_block_d *block  = vsip_blockcreate_d(400,0);
     ...
     vsip_mview_d *chk_nt = vsip_mcreate_d(3,3,VSIP_COL,0);
     vsip_mview_d *chk_tn = vsip_mcreate_d(5,5,VSIP_ROW,0);
     ...
     VU_msub_d(cnt,ans_nt,chk_nt); VU_mmag_d(chk_nt,chk_nt); VU_mclip_d(chk_nt,.0001,.0001,0,1,chk_nt);
     if(VU_msumval_d(chk_nt) > .5)
         printf("error\n");
     else
         printf("correct\n");
     ...
     VU_msub_d(ctn,ans_tn,chk_tn); VU_mmag_d(chk_tn,chk_tn); VU_mclip_d(chk_tn,.0001,.0001,0,1,chk_tn);
     if(VU_msumval_d(chk_tn) > .5)
         printf("error\n");
     else
         printf("correct\n");

...
/* $Id: cvjmul.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void cvjmul_d(){
   printf("********\nTEST cvjmul_d\n");
   {
     ...
     vsip_scalar_d ans_r[]    = { 28.12, 46.08, 71.82, 4.4, -16.0, -11.2 };
     vsip_scalar_d ans_i[]    = {-12.30, -23.60, 21.00, 49.28, 101.22, 9.18 };

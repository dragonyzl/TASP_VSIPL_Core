...
/* $Id: cvjdot.t,v 1.3 2000/04/14 12:27:55 judd Exp $ */
static void cvjdot_d(){
   printf("********\nTEST cvjdot_d\n");
   {
     ...
     vsip_cscalar_d ans = vsip_cmplx_d(123.22,144.78);
     vsip_cscalar_d val = vsip_cmplx_d(0,0);
     ...
     vsip_cvcopy_d_d(a,c);
     printf("val = vsip_cvjdot_d(a,b)\n");
     val = vsip_cvjdot_d(c,b);
     printf("vector a\n");VU_cvprintm_d("8.6",c);
     printf("vector b\n");VU_cvprintm_d("8.6",b);

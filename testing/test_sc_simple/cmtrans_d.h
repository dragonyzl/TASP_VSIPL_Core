...
/* $Id: cmtrans.t,v 1.4 2000/04/14 12:27:55 judd Exp $ */
static void cmtrans_d(){
   printf("********\nTEST cmtrans_d\n");
   {
     ...
     vsip_scalar_d data_2_i[] = {  1,  2,  3,  4,    
                                   -1.0, -1.1, -1.2, -1.3,
                                    .1, .2, .3, .4};
     vsip_cblock_d *block_1 = vsip_cblockbind_d(data_1_r,data_1_i,16,0);
     vsip_cblock_d *block_2 = vsip_cblockbind_d(data_2_r,data_2_i,12,0);
     vsip_cblock_d *block = vsip_cblockcreate_d(200,0);
     vsip_cmview_d *d_1   = vsip_cmbind_d(block_1,0,4,4,1,4);
     vsip_cmview_d *ans_d1 = vsip_cmbind_d(block_1,0,1,4,4,4);
     vsip_cmview_d *d_2   = vsip_cmbind_d(block_2,0,4,3,1,4);
     vsip_cmview_d *ans_d2 = vsip_cmbind_d(block_2,0,1,4,4,3);
     ...
     vsip_cmview_d *chk_1 = vsip_cmcreate_d(4,4,VSIP_COL,0);
     vsip_cmview_d *chk_2 = vsip_cmcreate_d(4,3,VSIP_COL,0);
     vsip_mview_d *chk_1_r = vsip_mrealview_d(chk_1);
     vsip_mview_d *chk_2_r =  vsip_mrealview_d(chk_2);
     vsip_cmview_d *ans_1 = vsip_cmcreate_d(4,4,VSIP_COL,0);
     vsip_cmview_d *ans_2 = vsip_cmcreate_d(4,3,VSIP_COL,0);
     ...
     printf("vsip_cmtrans_d(a_1,a_1)\n");
     vsip_cmtrans_d(a_1,a_1);
     printf("matrix a = ");VU_cmprintm_d("6.4",a_1);
     printf("matrix ans = ");VU_cmprintm_d("6.4",ans_1);
     VU_cmsub_d(a_1,ans_1,chk_1); VU_cmmag_d(chk_1,chk_1_r); VU_mclip_d(chk_1_r,.0001,.0001,0,1,chk_1_r);
     if(VU_msumval_d(chk_1_r) > .5)
         printf("error\n\n");
     else
         printf("correct\n\n");
     
     printf("3x4 out of place\n");
     printf("vsip_cmtrans_d(a,b)\n");
     printf("matrix a = "); VU_cmprintm_d("6.4",a_2);
     vsip_cmtrans_d(a_2,c_2);
     printf("matrix b = "); VU_cmprintm_d("6.4",c_2);
     printf("matrix ans = ");VU_cmprintm_d("6.4",ans_2);
     VU_cmsub_d(c_2,ans_2,chk_2); VU_cmmag_d(chk_2,chk_2_r); VU_mclip_d(chk_2_r,.0001,.0001,0,1,chk_2_r);
     if(VU_msumval_d(chk_2_r) > .5)
         printf("error\n");
     else
         printf("correct\n");

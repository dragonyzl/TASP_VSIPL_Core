...
**********************************************************************/
/* $Id: vsip_cblockadmit_d.c,v 1.1 1999/12/04 03:19:08 judd Exp judd $ */
/* Modified RJudd February 27, 1999 to return 0 on success */
#include<vsip.h>
#include<vsip_cblockattributes_d.h>

int (vsip_cblockadmit_d)(vsip_cblock_d* b,
                        vsip_scalar_bl update) {
  int blockadmit;
  if ((vsip_scalar_d*)NULL == b->R->array) blockadmit = 1; /* don't admit a block with no data */
  else   

...
**********************************************************************/
/* $Id: vsip_qrd_create_d.c,v 1.1 1999/12/05 16:08:10 judd Exp $ */
            ...
            vsip_qrd_qopt qopt)
{
  ...
  if(( qr != NULL)){
     if((qr->v = vsip_vcreate_d(M,VSIP_MEM_NONE))!= NULL){
        if((qr->w = vsip_vcreate_d((vsip_length)10 * M,VSIP_MEM_NONE)) != NULL){

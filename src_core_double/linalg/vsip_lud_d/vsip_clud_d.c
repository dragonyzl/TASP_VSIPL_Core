...
**********************************************************************/
/* $Id: vsip_clud_d.c,v 1.1 1999/12/05 16:07:51 judd Exp judd $ */
/* vsip_clud_d */    
#include<vsip.h>
...
static vsip_index VI_max_index_d(
    ...
    vsip_scalar_d *ap0_r = ap_r,
                  *ap0_i = ap_i;
    vsip_scalar_d max = *ap_i * *ap_i + *ap_r * *ap_r,
                  max0;
    vsip_index n;
    vsip_index index = 0; 
...
static int VI_mlud_update_rm_d(
    ...
    vsip_scalar_d *ap0_r = A->block->R->array + A->offset * A->block->cstride,
                  *ap0_i = A->block->I->array + A->offset * A->block->cstride;
    vsip_scalar_d *ap0_0_r = ap0_r,
                  *ap0_0_i = ap0_i;
    vsip_scalar_d *ap1_r = ap0_0_r + ac_st,
                  *ap1_i = ap0_0_i + ac_st;
    vsip_scalar_d *ap1_0_r = ap1_r,
                  *ap1_0_i = ap1_i;
    vsip_scalar_d pivot;
...
static int VI_mlud_update_cm_d(
    ...
    vsip_scalar_d *ap0_r = A->block->R->array + A->offset * A->block->cstride,
                  *ap0_i = A->block->I->array + A->offset * A->block->cstride;
    vsip_scalar_d *ap1_r = ap0_r + ac_st,
                  *ap1_i = ap0_i + ac_st;
    vsip_scalar_d *ap1_0_r = ap1_r,
                  *ap1_0_i = ap1_i;
    vsip_scalar_d *scp_r = ap1_r,
                  *scp_i = ap1_i; /* pointer to scaling factor */
    vsip_scalar_d *scp_0_r = ap1_r,
                  *scp_0_i = ap1_i; /* pointer to first element of scale column */
    vsip_scalar_d pivot = *ap0_r * *ap0_r + *ap0_i * *ap0_i,
                  scale;
    if(pivot == 0) return 1;
    /* calculate pivots */
    while(m++ < M){
    ...
    const vsip_cmview_d *A)
{
    ...
    vsip_offset  n_cl = 0;
    int (*lud_update_d)(vsip_cmview_d*) = ((A->row_stride < A->col_stride) ?

...
**********************************************************************/
/* $Id: vsip_ccfftmop_d.c,v 1.1 1999/12/05 01:58:59 judd Exp judd $ */
#include<vsip.h>
...
void VI_dftm_d(vsip_fftm_d *fft) {
...
void VI_fft2m_d(vsip_fftm_d* fft)
{
...
void VI_ifft2m_d(vsip_fftm_d* fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_cscalar_d a0, a1; 
...
void VI_fft3m_d(vsip_fftm_d* fft) 
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i; 
   vsip_stride ypst = fft->ypst;
...
void VI_ifft3m_d(vsip_fftm_d *fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft4m_d(vsip_fftm_d* fft) 
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_ifft4m_d(vsip_fftm_d *fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft5m_d(vsip_fftm_d* fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i; 
   vsip_stride ypst = fft->ypst;
...
void VI_ifft5m_d(vsip_fftm_d *fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft7m_d(vsip_fftm_d* fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i; 
   vsip_stride ypst = fft->ypst;
...
void VI_ifft7m_d(vsip_fftm_d* fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft8m_d(vsip_fftm_d *fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i; 
   vsip_stride ypst = fft->ypst;
...
void VI_ifft8m_d(vsip_fftm_d* fft)
{
   vsip_scalar_d *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft_wtm_d(vsip_fftm_d *fft)
{
      vsip_cvview_d A0 = *fft->x;
      vsip_cvview_d *a = &A0;
      vsip_cvview_d *b = fft->wt;
...
void VI_p0pFm_d(vsip_fftm_d *fft)
{
  ...
  void (*fft_p)(vsip_fftm_d*) = VI_p0pFm_d;
...
/* init fft to x */
void VI_init_fftm_d(vsip_cmview_d *X,vsip_fftm_d* fft){
...
void VI_ccfftmip_d(const vsip_fftm_d* fft, const vsip_cmview_d *X)
{
  VI_init_fftm_d((void*)X,(void*)fft);
  if(fft->dft == 1){
     VI_dftm_d((void*)fft);
  }else{
     VI_p0pFm_d((void*)fft);
     VI_sortm_copy_d((void*)fft);
  }
  if (fft->scale != 1){ 
     vsip_cvview_d A0 = *fft->x;
     vsip_cvview_d *x = &A0;
...
void VI_sortm_copy_d(vsip_fftm_d* fft){

...
**********************************************************************/
/* $Id: vsip_ccfftmop_f.c,v 1.1 1999/12/02 18:53:23 judd Exp judd $ */
#include<vsip.h>
...
void VI_dftm_f(vsip_fftm_f *fft) {
...
void VI_fft2m_f(vsip_fftm_f* fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
...
void VI_ifft2m_f(vsip_fftm_f* fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_cscalar_f a0, a1; 
...
void VI_fft3m_f(vsip_fftm_f* fft) 
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i; 
   vsip_stride ypst = fft->ypst;
...
void VI_ifft3m_f(vsip_fftm_f *fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft4m_f(vsip_fftm_f* fft) 
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_ifft4m_f(vsip_fftm_f *fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft5m_f(vsip_fftm_f* fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i; 
   vsip_stride ypst = fft->ypst;
...
void VI_ifft5m_f(vsip_fftm_f *fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft7m_f(vsip_fftm_f* fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i; 
   vsip_stride ypst = fft->ypst;
...
void VI_ifft7m_f(vsip_fftm_f* fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft8m_f(vsip_fftm_f *fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i; 
   vsip_stride ypst = fft->ypst;
...
void VI_ifft8m_f(vsip_fftm_f* fft)
{
   vsip_scalar_f *xp_rp = fft->xp_r,
                 *xp_ip = fft->xp_i;
   vsip_stride ypst = fft->ypst;
...
void VI_fft_wtm_f(vsip_fftm_f *fft)
{
      vsip_cvview_f A0 = *fft->x;
      vsip_cvview_f *a = &A0;
      vsip_cvview_f *b = fft->wt;
...
void VI_p0pFm_f(vsip_fftm_f *fft)
{
  ...
  void (*fft_p)(vsip_fftm_f*) = VI_p0pFm_f;
...
void VI_init_fftm_f(vsip_cmview_f *X,vsip_fftm_f* fft){
  if(fft->major == VSIP_COL){
     fft->x = VI_cmcolview_f(X,0,&fft->xx);
     fft->ypst = X->block->cstride * X->row_stride;
     fft->yst =  X->row_stride;
  }else{
     fft->x = VI_cmrowview_f(X,0,&fft->xx);
...
void VI_ccfftmip_f(const vsip_fftm_f* fft, const vsip_cmview_f *X)
{
...
void VI_sortm_copy_f(vsip_fftm_f* fft){

...
**********************************************************************/
/* $Id: vsip_blockadmit_f.c,v 1.1 1999/12/04 02:52:43 judd Exp judd $ */
...
int (vsip_blockadmit_f)(vsip_block_f* b,
                        vsip_scalar_bl update) {
  int blockadmit;
  if ((vsip_scalar_f*)NULL == b->array) blockadmit = 1; /* don't admit a block with no data */
  else   

...
**********************************************************************/
/* $Id: vsip_blockrelease_vi.c,v 1.1 1999/12/04 02:57:06 judd Exp judd $ */
...
vsip_scalar_vi* (vsip_blockrelease_vi)(vsip_block_vi* b,
                        vsip_scalar_bl update) {	
  if ((vsip_block_vi*) NULL == b) return (vsip_scalar_vi*)NULL;
  else

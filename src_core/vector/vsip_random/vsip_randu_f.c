...
**********************************************************************/
/* $Id: vsip_randu_f.c,v 1.1 1999/12/02 19:04:28 judd Exp judd $ */
#include<vsip.h>
     ...
     vsip_randstate *state)
{
   ...
   { /* nonportable generator */
      ...
      X    = a * X + c;
      state->X = X;
      return ((vsip_scalar_f)X/(vsip_scalar_f)4294967296.0);
      ...
      return((vsip_scalar_f)itemp/(vsip_scalar_f)16777216.0);
   }
}

...
**********************************************************************/
/* $Id: vsip_blockadmit_si.c,v 1.1 1999/12/05 16:36:22 judd Exp judd $ */
/* Modified RJudd February 27, 1999 to return 0 on success */
#include<vsip.h>
#include<vsip_blockattributes_si.h>

int (vsip_blockadmit_si)(vsip_block_si* b,
                        vsip_scalar_bl update) {
  int blockadmit;
  if ((vsip_scalar_si*)NULL == b->array) blockadmit = 1; /* don't admit a block with no data */
  else   
